...
author: "Arsyalhaad 123180093 & Faisal S.H 123180118"
...
## Cleaning Dataset
```{r load dataset}
datanya <- vroom(here('D:/Kool Yeah/Data Science/Analisis Sentimen/datasets.csv'))
komen <- datanya$text
...
datanya<-read.csv("D:/Kool Yeah/Data Science/Analisis Sentimen/dataclean.csv",stringsAsFactors = FALSE)
...
library(dplyr)
library(caret)
df<-read.csv("D:/Kool Yeah/Data Science/Analisis Sentimen/dataclean.csv",stringsAsFactors = FALSE)
glimpse(df)
...
twitter<- vroom(here("D:/Kool Yeah/Data Science/Analisis Sentimen/dataclean.csv"))
tweet<- twitter$text
ui <- fluidPage(
    titlePanel("Analisa"),
        mainPanel(
...
server <- function(input, output) {
    ...
    output$scatterplot <- renderPlot({produk_dataset<-read.csv("D:/Kool Yeah/Data Science/Analisis Sentimen/dataclean.csv",stringsAsFactors = FALSE)
